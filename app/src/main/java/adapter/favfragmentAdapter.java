...
public class favfragmentAdapter extends RecyclerView.Adapter<favfragmentAdapter.CategoryViewHolder> {

    private Context context;
    private List<ThemainscreenFragment.CategoryWithCourses> categoriesWithCourses;

    public favfragmentAdapter(Context context, List<ThemainscreenFragment.CategoryWithCourses> categoriesWithCourses) {
