...
public class CoursePageFav extends AppCompatActivity {

    private ImageButton back_course, love, reviews, nachat;
    private boolean isLoved;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_course_fav);
        ...
        reviews.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CoursePageFav.this, Reviews.class);
